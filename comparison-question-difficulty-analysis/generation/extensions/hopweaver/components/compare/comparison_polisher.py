...
class ComparisonPolisher:
    ...
    def polish_questions_from_data(self, questions_data, output_file=None, save_output=True):
        ...
        for i, question in enumerate(questions, 1):
            ...
            entity_c = question.get("entity_c", "") 
            ...
            fact_c = question.get("fact_entity_c", "")
            ...
            doc_c_context = question.get("relevant_paragraph_c") or self._extract_document_context(
                  question.get("document_c", {}).get("contents", "")
            )

            # Optimize question
            polished_result = self._polish_question(
                entity_a, entity_b, entity_c, attribute,
                original_question, original_answer,
                fact_a, fact_b,fact_c,
                doc_a_context, doc_b_context, doc_c_context
            )
            ...
            if polished_result:
                ...
                complete_result = {
                    ...
                    "document_c": question.get("document_c", {}),
    ...
    def _polish_question(self, entity_a, entity_b, entity_c, attribute,
                        original_question, original_answer,
                        fact_a, fact_b, fact_c,
                        doc_a_context, doc_b_context, doc_c_context):
        """
        ...
        try:
            ...
            prompt = COMPARISON_POLISHER_PROMPT.format(
                ...
                document_c_context=doc_c_context
            )
