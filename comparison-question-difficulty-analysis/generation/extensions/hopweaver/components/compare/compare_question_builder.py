...
class CompareQuestionBuilder:
    ...
    def build_question(self, entity_data, candidate_doc_b, candidate_doc_c=None,
                   document_a_text=None, max_retries=3):
        ...
        print(f"  Candidate Document B Title: {candidate_doc_b.get('title', 'Unknown')}")
        ...
        document_b_text = candidate_doc_b.get("contents", "")
        document_c_text = candidate_doc_c.get("contents", "")
        ...
        try:
            ...
            prompt_params = {
                ...
                "document_c_text": document_c_text,
            }
            ...
            if document_c_text:
                print(f"  Document C content preview: {document_c_text[:50]}...")
            else:
                print(f"  Document C content is empty")
        ...
        for attempt in range(max_retries):
            try:
                ...
                # Parse response
                question_result = self._parse_question_response(response[0], entity_data, candidate_doc_b, candidate_doc_c)
    ...
    def _parse_question_response(self, response, entity_data, candidate_doc_b, candidate_doc_c):
        """
        ...
        result = {
            ...
            "relevant_paragraph_c": "",
            "document_a": entity_data,
            "document_b": candidate_doc_b,
            "document_c": candidate_doc_c
        }
        ...
        for i, (marker, start_pos) in enumerate(sorted_markers):
            ...
            elif key in ["fact_entity_c", "fact_c"]:
                result["fact_entity_c"] = content

            elif key == "entity_c":
                result["entity_c"] = content

            elif key == "relevant_paragraph_c":
                result["relevant_paragraph_c"] = content
                    
        # Check if all required fields are filled
        required_fields = [
            "entity_a", "entity_b", "entity_c",
            "attribute_compared",
            "multi_hop_question", "answer",
            "fact_entity_a", "fact_entity_b", "fact_entity_c",
            "relevant_paragraph_a", "relevant_paragraph_b", "relevant_paragraph_c"
        ]
