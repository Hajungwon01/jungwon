...
class CompareRetriever:
    ...
    def retrieve_documents(self, query, doc_id=None, top_k=2):
        """
    ...
    def process_recall_focused_verify(self, query_result, top_k=3):
        ...
        results = self.retrieve_documents(verification_query, doc_id=doc_id, top_k=2)
        ...
        return {
            ...
            "entity_c_name": query_result.get("entity_c_name", ""),
            "attribute_x": query_result.get("attribute_x", ""),
            "verification_query": verification_query,
            "retrieved_documents": results
        }
    
    def process_search_queries(self, query_result, top_k=2):
        """
